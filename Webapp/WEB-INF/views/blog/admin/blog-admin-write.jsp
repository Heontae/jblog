	...
	<div id="wrap">
		...
		<div id="content">
			<ul id="admin-menu" class="clearfix">
				...
				<li class="tabbtn selected"><a href="${pageContext.request.contextPath}/${session.id }/admin/writeForm">글작성</a></li>
			</ul>
			<!-- //admin-menu -->
			
			<div id="admin-content">
				<form action="${pageContext.request.contextPath}/${session.id }/admin/write" method="get">
